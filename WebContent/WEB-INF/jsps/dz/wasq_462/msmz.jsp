...
<div class="slider">
	<ul class="slide-banner">
		<li><img src="${global_image_url}/icon/dz_wasq/banner_msmz.png"></li>
	</ul>
</div>
...
<section class="module ">
        <div class="tit_bar"">
            <h5 class="tit_name"><img class="tit_icon" src="${global_image_url }/ico_jbts.png"  />&nbsp;民生民政</h5>
        </div>
</section>	
	...
	<ul class="channels">
		...
		<li class="slides js_slides">
			<a href="${global_url}/wfw/wgy/getWGYList.htm?shequId=${shequId}">
				<img style="width:50px" src="${global_image_url }/ico_jbts.png"" />
				<p>网格人员</p>
			</a>
		</li>	
