...
function GetAjaxData() {
	var url = "${global_url}/zhsq/yuyue/getShequYuyueListAsync.htm?pageno="
...
function appendHtml(item) {
	var html = '<li>'
				+ '<a href="${global_url}/zhsq/yuyue/getShequYuyueInfo.htm?yuyueId='+${item.yuyueId}+'">'
				+'<img src="'+${global_image_url}+'/class1.png" class="pic"></a>'
				+ '<div class="rt">'
				+ '<div class="tit"><a href="${global_url}/zhsq/yuyue/getShequYuyueInfo.htm?yuyueId='
	...
	<ul class="allcon">
		<c:if test="${not empty yuyueList}">
			<c:forEach var="yuyueMap" items="${yuyueList}">
				<li><a href="${global_url}/zhsq/yuyue/getShequYuyueInfo.htm?yuyueId=${yuyueMap.yuyueId}"><img src="${global_image_url}/class1.png" class="pic"></a>
					<div class="rt">
						<div class="tit">
							<a href="${global_url}/zhsq/yuyue/getShequYuyueInfo.htm?yuyueId=${yuyueMap.yuyueId}">预约事项：${yuyueMap.action}</a>
						</div>
