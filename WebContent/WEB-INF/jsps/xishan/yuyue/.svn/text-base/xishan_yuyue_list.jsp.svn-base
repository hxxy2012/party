...
function GetAjaxData() {
	var url = "${global_url}/xishan/yuyue/getXishanYuyueListAsync.htm?pageno="
...
function appendHtml(item) {
	var html = '<li>'
				+ '<a href="${global_url}/xishan/yuyue/getXishanYuyueInfo.htm?yuyueId='+${item.yuyueId}+'">'
				+'<img src="'+${global_image_url}+'/class1.png" class="pic"></a>'
				+ '<div class="rt">'
				+ '<div class="tit"><a href="${global_url}/xishan/yuyue/getXishanYuyueInfo.htm.htm?yuyueId='
				+ ${item.yuyueId}+'">'+'预约事项：'+${item.action} + '</a></div>'
				+ '<div class="yy_list_cont">'+'预约单位：'+${item.companyName}+'</div>'
...
<body>
	...
	<div class="slider">
		<ul class="slide-banner">
			<li><img src="${xishan_image_url}/banner_bsyy.jpg"></li>
		</ul>
	</div>
	<%-- 
<div class="sousuo">
		...
		<c:if test="${not empty yuyueList}">
			<c:forEach var="yuyueMap" items="${yuyueList}">
				<li><a href="#"><img src="${global_image_url}/class1.png" class="pic"></a>
					<div class="rt">
						<div class="tit">
							<a href="${global_url}/xishan/yuyue/getXishanYuyueInfo.htm?yuyueId=${yuyueMap.yuyueId}">预约事项：${yuyueMap.action}</a>
						</div>
						<div class="tit">
							<!-- <span class="yy_icon1"></span> -->预约单位：${yuyueMap.companyName}
						</div>
