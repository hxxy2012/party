...
<div class="loginbody">
	...
	<form id="login_form" name="login_form" action="${global_url}/member/memberLogin.htm" method="post">    
	  ...
	  <ul class="logininput">
	        ...
	        <li>
		        ...
		        <input placeholder="请输入密码" name="login_password" id="login_password" type="password" onblur="checkPassword();" >
	  ...
	  <div class="wjmima"><a href="${global_url}/member/memberRegister.htm" style=" float:left">立即注册</a><a href="${global_url}/member/findPassword.htm" style=" float:right">忘记密码</a></div>
	  <button  type="button" class="denglu" value="微信登录" onclick="location.href='http://weixin.gangwaninfo.com/Weixin/member/login.htm?shequId=${shequId}';">微信登录</button>
	</form>
</div>
