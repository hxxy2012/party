...
function GetAjaxData(){
	var title = "${title}";
	var url = "${global_url}/streetNews/getStreetNewsListAsync.htm?streetId="+${streetId}+"&classId="+${classId}+"&pageno="+(pageno*1+1)+"&pageSize="+pageSize;
	if(title != null && title != "" ){
		url = url+"&title="+title;
	}
...
function appendHtml(item){
	var html = '<li><a href="${global_url}/streetNews/getStreetNewsInfo.htm?newsId='+item.newsId+'"><img src="'+item.paramMap.imagePaths+'" class="pic"></a>'
				+'<div class="rt"><div class="tit"><a href="${global_url}/streetNews/getStreetNewsInfo.htm?newsId='+item.newsId+'">'+item.title +'</a></div>'
...
<body>
	<div id="divObj">
		...
		<!-- 搜索 -->
		<div class="sousuo">
			<form id="form_sousuo" action="${global_url}/streetNews/getStreetNewsList.htm?streetId=${streetId}&className=${className}&classId=${classId}" method="post">
				...
				<ul class="allcon">
					<c:if test="${not empty newsList}">
						<c:forEach var="newsMap" items="${newsList}">
							<li><a
								href="${global_url}/streetNews/getStreetNewsInfo.htm?newsId=${newsMap.newsId}&className=${className}">
								...
								<div class="rt">
									<div class="tit">
										<a
											href="${global_url}/streetNews/getStreetNewsInfo.htm?newsId=${newsMap.newsId}&className=${className}">${newsMap.title }</a>
									</div>
									<div class="dush">
										<div class="haoping">
