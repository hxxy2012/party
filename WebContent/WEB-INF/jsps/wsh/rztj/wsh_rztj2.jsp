...
<script>
//var jsapi_ticket="kgt8ON7yVITDhtdwci0qeZGxYUKahgp7Saz0crSYTC8-Y9Y1OnqAQwOrdQ0HcSmVOf2bNfMl4_EB10MozW7pUg";
//var string1 = "jsapi_ticket=kgt8ON7yVITDhtdwci0qeZGxYUKahgp7Saz0crSYTC8-Y9Y1OnqAQwOrdQ0HcSmVOf2bNfMl4_EB10MozW7pUg&noncestr=Zhi2015Hui11She13Qu&timestamp=1420774989&url=http://weixintest.xuexipindao.cn/Weixin/wsh/rztj/init.htm?shequId=202";
wx.config({
      debug: false,
      appId: '${appId}',
      timestamp: 1420774989,
      nonceStr: 'Zhi2015Hui11She13Qu',
      signature: '9ed957a999fd61e63867f7d46006f4f279366f84',
      jsApiList: [
        'checkJsApi',
        'onMenuShareTimeline',
